...
procedure TMyTrayIcon.SetActive(Value : boolean);
begin
...
procedure TMyTrayIcon.SetShowDesigning(Value : boolean);
begin
...
procedure TMyTrayIcon.SetToolTip(Value : string);
begin
...
procedure TMyTrayIcon.FillDataStructure;
begin
...
function TMyTrayIcon.AddIcon : boolean;
begin
   FillDataStructure;
...
function TMyTrayIcon.ModifyIcon : boolean;
begin
...
procedure TMyTrayIcon.DoRightClick( Sender : TObject );
var MouseCo: Tpoint;
begin
...
function TMyTrayIcon.DeleteIcon : boolean;
begin
   result := Shell_NotifyIcon(NIM_DELETE,@IconData);
end;

procedure TMyTrayIcon.WndProc(var msg : TMessage);
begin
   with msg do
...
procedure Register;
begin
  RegisterComponents('ConTEXT Components', [TMyTrayIcon]);
end;
