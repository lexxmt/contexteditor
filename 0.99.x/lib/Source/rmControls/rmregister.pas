...
uses rmBaseEdit, rmSpeedBtns, rmScrnCtrls, rmBtnEdit, rmColorComboBox,
     ...
     rmCollectionListBox, rmTreeNonView, rmTreeNonViewEdit, rmDiff,
     rmSpinCombo, rmBtnCombo, rmCaptionButtons, rmCornerGrip, rmKeyBindings, rmKeyBindingPropEdit,
     rmBrowseFor, rmTrayIcon, rmImageListGraphic, rmEditGrid, rmListControl,
     rmHint, rmInspector, rmInspectorItems, rmInspectorEdit, rmOutlook, rmOutlookReg,
     rmOutlookExtras, rmDGT, rmToolWin, rmToolWinFormExpt, rmCheckBox,
...
begin
  ...
  //Components Registration
     ...
     //rmNonVisual
     RegisterComponents(PalettePages[4],[TrmTreeNonView, TrmDGTree, TrmWordTree]);
