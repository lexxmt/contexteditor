...
var
  ...
  DrawTextW_MP: function(hDC: HDC; lpString: PWideChar; nCount: Integer; var lpRect: TRect; uFormat: UINT): Integer; stdcall;
  SHGetFileInfoW_MP: function(pszPath: PWideChar; dwFileAttributes: DWORD; var psfi: TSHFileInfoW; cbFileInfo, uFlags: UINT): DWORD; stdcall;
  CreateFileW_MP: function(lpFileName: PWideChar; dwDesiredAccess, dwShareMode: DWORD; lpSecurityAttributes: PSecurityAttributes; dwCreationDisposition, dwFlagsAndAttributes: DWORD; hTemplateFile: THandle): THandle; stdcall;
  SHGetDataFromIDListW_MP: function(psf: IShellFolder; pidl: PItemIDList; nFormat: Integer; ptr: Pointer; cb: Integer): HResult; stdcall;
  ...
  GetDiskFreeSpaceW_MP: function(lpRootPathName: PWideChar; var lpSectorsPerCluster, lpBytesPerSector, lpNumberOfFreeClusters, lpTotalNumberOfClusters: DWORD): BOOL; stdcall;
  ...
  AllowSetForegroundWindow_MP: function(dwProcessID: DWORD): BOOL; stdcall;
  ...
  GetModuleFileNameW_MP: function(hModule: HINST; lpFilename: PWideChar; nSize: DWORD): DWORD; stdcall;
  ...
  GetShortPathNameW_MP: function(lpszLongPath: PWideChar; lpszShortPath: PWideChar; cchBuffer: DWORD): DWORD; stdcall;
  ...
  GetDiskFreeSpaceExA_MP: function(lpDirectoryName: PAnsiChar; var lpFreeBytesAvailableToCaller, lpTotalNumberOfBytes; lpTotalNumberOfFreeBytes: PLargeInteger): BOOL; stdcall;
  GetDiskFreeSpaceExW_MP: function(lpDirectoryName: PWideChar; var lpFreeBytesAvailableToCaller, lpTotalNumberOfBytes; lpTotalNumberOfFreeBytes: PLargeInteger): BOOL; stdcall;
  GetNumberFormatW_MP: function(Locale: LCID; dwFlags: DWORD; lpValue: PWideChar; lpFormat: PNumberFmtW; lpNumberStr: PWideChar; cchNumber: Integer): Integer; stdcall;
  ...
  ExpandEnvironmentStringsForUserW_MP: function(hToken: THandle; lpSrc: PWideChar; lpDst: PWideChar; nSize: DWORD): BOOL; stdcall;
  ExpandEnvironmentStringsForUserA_MP: function(hToken: THandle; lpSrc: PAnsiChar; lpDst: PAnsiChar; nSize: DWORD): BOOL; stdcall;
  ...
  Wow64RevertWow64FsRedirection_MP: function(OldValue: Pointer): BOOL; stdcall;
  Wow64DisableWow64FsRedirection_MP: function(var OldValue: Pointer): BOOL; stdcall;
  Wow64EnableWow64FsRedirection_MP: function(Wow64FsEnableDirection: BOOLEAN): BOOLEAN; stdcall;
...
begin      
  Result := False;
  if Assigned(Image32) and (Image32.PixelFormat = pf32Bit) and (Image32.Height > 0) then
  begin
...
initialization
  ...
  begin
    ...
    begin
      ...
      Wow64EnableWow64FsRedirection_MP := GetProcAddress(Kernel32Handle, 'Wow64EnableWow64FsRedirection');
    end
  end;
