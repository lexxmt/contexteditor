...
const
  ...
  CSpTBXSkinComponents: array [TSpTBXSkinComponentsType] of TSpTBXSkinComponentsIdentEntry = (
    ...
    (Name: 'ListItem';              States: [sknsHotTrack]),
...
type
  ...
  public
    ...
    procedure Reset(ForceResetSkinProperties: Boolean = True);
...
procedure TSpTBXSkinOptions.Reset(ForceResetSkinProperties: Boolean = True);
var
  C: TSpTBXSkinComponentsType;
  S: TSpTBXSkinStatesType;
begin
