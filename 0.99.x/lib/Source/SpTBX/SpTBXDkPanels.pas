...
uses
  Types, ComCtrls, Registry, TB2Consts, TB2Common;
  ...
  if DP.Docked then begin
    ...
    try
      ...
      if ResizeType = dprtSplitResize then
        SpDPUpdateDockPos(MultiDock)  // Update DockPos of all the DPs, including the non-visible DPs
    end;
  end
  else begin
