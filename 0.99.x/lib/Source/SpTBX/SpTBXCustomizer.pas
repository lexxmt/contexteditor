...
{$ENDIF}
  ...
  public
    ...
    procedure Save(IniFile: TCustomIniFile); overload;
...
procedure TSpTBXCustomizer.Save(IniFile: TCustomIniFile);
var
  ExtraL: TStringList;
  ShortcutsL: TSpTBXMenuBarShortcuts;
begin
...
procedure TSpTBXCustomizer.Save(const RootKey: DWORD; BaseRegistryKey: string);
var
  Reg: TRegistryIniFile;
begin
