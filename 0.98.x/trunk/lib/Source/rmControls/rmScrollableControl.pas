...
type
  ...
  protected
    ...
    property VeritcalScrollByChar: boolean read fVeritcalScrollByChar write fVeritcalScrollByChar;
  public
    { Public declarations }
