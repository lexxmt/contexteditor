...
function TSynPHPSyn.Func20: TtkTokenKind;
begin
...
function TSynPHPSyn.Func35: TtkTokenKind;
begin
...
begin
  if KeyComp('new') or KeyComp('final') then
    Result := tkKey
  else
    Result := tkIdentifier;
end;

function TSynPHPSyn.Func45: TtkTokenKind;
begin
...
begin
  if KeyComp('false') then Result := tkKey else
    if KeyComp('int') then Result := tkKey else
      if KeyComp('define') then Result := tkKey else Result := tkIdentifier;
end;

function TSynPHPSyn.Func47: TtkTokenKind;
begin
  if KeyComp('defined') then Result := tkKey else Result := tkIdentifier;
end;

function TSynPHPSyn.Func48: TtkTokenKind;
begin
...
begin
  if KeyComp('global') or KeyComp('clone') then
    Result := tkKey
  else
    Result := tkIdentifier;
end;
...
begin
  if KeyComp('double') or KeyComp('null') then
    Result := tkKey
  else
    Result := tkIdentifier;
end;
...
begin
  if KeyComp('array') or KeyComp('public') or KeyComp('try') then
    Result := tkKey
  else
    Result := tkIdentifier;
end;
...
begin
  if KeyComp('const') or KeyComp('enddeclare') then
    Result := tkKey
  else
    Result := tkIdentifier;
end;
...
begin
  if KeyComp('empty') or KeyComp('unset') or KeyComp('endforeach') then
    Result := tkKey
  else
    Result := tkIdentifier;
end;
...
function TSynPHPSyn.Func81: TtkTokenKind;
begin
...
function TSynPHPSyn.Func84: TtkTokenKind;
begin
  if KeyComp('abstract') or KeyComp('throw') then
    Result := tkKey
  else
    Result := tkIdentifier;
end;
...
function TSynPHPSyn.Func90: TtkTokenKind;
begin
  if KeyComp('__call') then Result := tkKey else Result := tkIdentifier;
end;

function TSynPHPSyn.Func91: TtkTokenKind;
begin
  if KeyComp('extends') or KeyComp('private') then
    Result := tkKey
  else
    Result := tkIdentifier;
end;
...
function TSynPHPSyn.Func94: TtkTokenKind;
begin
  if KeyComp('__get') then Result := tkKey else Result := tkIdentifier;
end;
...
function TSynPHPSyn.Func106: TtkTokenKind;
begin
  if KeyComp('constant') or KeyComp('protected') or KeyComp('__set') then
    Result := tkKey
  else
    Result := tkIdentifier;
end;
...
begin
  if KeyComp('__clone') or KeyComp('exception') then
    Result := tkKey
  else
    Result := tkIdentifier;
end;

function TSynPHPSyn.Func119: TtkTokenKind;
begin
  if KeyComp('__sleep') then Result := tkKey else Result := tkIdentifier;
end;

function TSynPHPSyn.Func126: TtkTokenKind;
begin
  if KeyComp('implements') then Result := tkKey else Result := tkIdentifier;
end;

function TSynPHPSyn.Func134: TtkTokenKind;
begin
  if KeyComp('__isset') then Result := tkKey else Result := tkIdentifier;
end;

function TSynPHPSyn.Func136: TtkTokenKind;
begin
  if KeyComp('include_once') then Result := tkKey else Result := tkIdentifier;
end;

function TSynPHPSyn.Func139: TtkTokenKind;
begin
  if KeyComp('__wakeup') then Result := tkKey else Result := tkIdentifier;
end;

function TSynPHPSyn.Func141: TtkTokenKind;
begin
  if KeyComp('__unset') then Result := tkKey else Result := tkIdentifier;
end;

function TSynPHPSyn.Func151: TtkTokenKind;
begin
  if KeyComp('highlight_file') or KeyComp('__autoload') then
    Result := tkKey
  else
    Result := tkIdentifier;
end;
...
function TSynPHPSyn.Func161: TtkTokenKind;
begin
  if KeyComp('require_once') then Result := tkKey else Result := tkIdentifier;
end;
...
function TSynPHPSyn.Func172: TtkTokenKind;
begin
  if KeyComp('__destruct') then Result := tkKey else Result := tkIdentifier;
end;
...
function TSynPHPSyn.Func178: TtkTokenKind;
begin
  if KeyComp('__CLASS__') then Result := tkKey else Result := tkIdentifier;
end;

function TSynPHPSyn.Func184: TtkTokenKind;
begin
  if KeyComp('__toString') then Result := tkKey else Result := tkIdentifier;
end;

function TSynPHPSyn.Func189: TtkTokenKind;
begin
  if KeyComp('__METHOD__') then Result := tkKey else Result := tkIdentifier;
end;

function TSynPHPSyn.Func195: TtkTokenKind;
begin
  if KeyComp('__construct') then Result := tkKey else Result := tkIdentifier;
end;

function TSynPHPSyn.Func202: TtkTokenKind;
begin
  if KeyComp('__set_state') then Result := tkKey else Result := tkIdentifier;
end;
...
function TSynPHPSyn.Func226: TtkTokenKind;
begin
  if KeyComp('__FUNCTION__') then Result := tkKey else Result := tkIdentifier;
end;
...
begin
  ...
  if HashKey < 227 then Result := fIdentFuncTable[HashKey] else Result := tkIdentifier;
end;
