...
uses
  ...
  StdCtrls, ShellApi, VirtualWideStrings;
...
begin
  VirtualShellHistory.FillPopupMenu(PopupMenu1, fpdNewestToOldest, False, '');
end;

procedure TForm1.PopupMenu2Popup(Sender: TObject);
begin
  VirtualShellHistory.FillPopupMenu(PopupMenu2, fpdOldestToNewest, False, '');
end;
