...
type
  TForm1 = class(TForm)
    ...
    procedure VirtualCommandLineRedirector1ErrorInput(Sender: TObject;
      NewInput: String);
    procedure VirtualCommandLineRedirector1DirChange(Sender: TObject;
      NewDir: String; var Allow: Boolean);
...
procedure TForm1.VirtualCommandLineRedirector1DirChange(Sender: TObject;
  NewDir: String; var Allow: Boolean);
begin
  beep;
end;
