...
Type
  TForm1 = Class(TForm)
    ...
    Procedure VET1AddCustomShellColumn(Sender: TCustomVirtualExplorerTree;
...
Procedure TForm1.VET1AddCustomShellColumn(
...
Begin
  If CheckBoxCustomColumn.Checked Then Begin
    ...
    FCustomColumn := FirstAvailableIndex;
  End
End;
...
Begin
  ...
  If Not Namespace.Folder Then { Don't filter folders }
    If Not Namespace.Folder And (Pos(FileExt, UpperCase(EditFilter.Text)) = 0) Then
      AllowAsChild := False;
End;
